    ...
    <motion.div
      ...
      {hovered && (
        <>
          <motion.div className="absolute inset-0 rounded-2xl"
            style={{ background: "radial-gradient(circle at 100% 0%, rgba(0,224,255,0.08), transparent 65%)" }}
          ...
          <motion.div className="absolute right-0 top-4 bottom-4 w-0.5 rounded-full"
            style={{ background: "linear-gradient(180deg,transparent,#00E0FF,transparent)" }}
      ...
      <div className="relative z-10">
        <motion.h2 className="text-white font-bold text-base mb-3 flex items-center gap-2"
          animate={hovered ? { x: 2 } : { x: 0 }} transition={{ duration: 0.2 }}>
          <motion.span className="text-[10px] font-mono px-2 py-0.5 rounded-full shrink-0"
      ...
      <div className="max-w-3xl mx-auto relative z-10">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
          <div className="flex items-center gap-4 mb-8">
            ...
            <div>
              <motion.span className="text-xs font-mono text-[#00E0FF] tracking-widest uppercase block mb-1"
          ...
          <motion.div className="flex items-center gap-3 mb-8 p-4 rounded-2xl relative overflow-hidden"
            ...
            <motion.div className="w-2 h-2 rounded-full bg-[#00E0FF]"
              animate={{ scale: [1, 1.5, 1], boxShadow: ["0 0 0 0 #00E0FF40", "0 0 0 8px #00E0FF00"] }}
