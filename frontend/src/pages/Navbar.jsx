    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <motion.button
          ...
          whileHover={{ scale: 1.1, borderColor: "rgba(124,92,255,0.5)" }}
          whileTap={{ scale: 0.9 }}
        ...
        >
          <AnimatePresence mode="wait">
            {menuOpen ? (
              <motion.span key="x" initial={{ rotate: -90, opacity: 0, scale: 0.5 }} animate={{ rotate: 0, opacity: 1, scale: 1 }} exit={{ rotate: 90, opacity: 0, scale: 0.5 }} transition={{ duration: 0.22 }}>
                <HiX size={18} />
              </motion.span>
            ) : (
              <motion.span key="menu" initial={{ rotate: 90, opacity: 0, scale: 0.5 }} animate={{ rotate: 0, opacity: 1, scale: 1 }} exit={{ rotate: -90, opacity: 0, scale: 0.5 }} transition={{ duration: 0.22 }}>
                <HiMenuAlt3 size={18} />
              </motion.span>
            )}
          </AnimatePresence>
      ...
      <AnimatePresence>
        {menuOpen && (
          ...
          >
            <div className="absolute top-0 left-0 right-0 h-px" style={{ background: "linear-gradient(90deg,transparent,#7C5CFF50,transparent)" }} />
            <div className="flex flex-col px-6 py-5 gap-1">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.02, boxShadow: "0 0 20px rgba(124,92,255,0.5)" }}
                  whileTap={{ scale: 0.97 }}
