...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-white/8 overflow-hidden" style={{ background: "#05050A" }}>
      ...
      {/* Top glow */}
      <motion.div
        className="absolute top-0 left-1/2 -translate-x-1/2 w-80 h-24 opacity-12 blur-3xl pointer-events-none"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-[#9CA3AF] text-sm leading-relaxed mb-5 max-w-xs">
              4-agent AI decision intelligence platform. Upload 3 CSVs, train 3 ML models on your data, get PKL-validated strategy recommendations.
            </p>

            <motion.a
              href="mailto:bharathbandi13925@gmail.com"
            ...
            <div className="flex gap-2">
              {socials.map(({ icon, label, href, color }) => (
                ...
                >
                  {hoveredSocial === label && (
                    <motion.div className="absolute inset-0" style={{ background: `${color}15` }} initial={{ opacity: 0 }} animate={{ opacity: 1 }} />
                  )}
          ...
          <div className="md:col-span-1">
            ...
            <div className="space-y-3">
              {pipeline.map(({ label, color, desc, icon: Icon }, i) => (
                ...
                >
                  ...
                  <motion.div
                    className="w-1.5 h-1.5 rounded-full shrink-0 opacity-0 group-hover:opacity-100"
            ...
            <div className="mt-5 pt-4 border-t border-white/6">
              ...
              <div className="flex gap-2 flex-wrap">
                {["Random Forest", "XGBoost", "LightGBM", "SHAP"].map((t) => (
                  <motion.span
                    key={t}
